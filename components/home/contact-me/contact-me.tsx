...
export default function ContactMe() {
  return (
    <section id="contact" className="md:my-40 my-20">
      <div className="max-w-5xl mx-auto">
        ...
        >
          <div className="relative text-center mb-12">
            ...
            <h2 className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-4xl md:text-5xl w-[375px] font-bold">
              Contact me
            </h2>
            <p className="w-full md:max-w-xl mx-auto text-sm text-textPrimary dark:text-textSecondary">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          >
            <div className="flex lg:flex-col lg:items-start md:flex-row md:justify-between md:items-end flex-col">
              ...
              {/* Social Links */}
              <div className="space-y-5 lg:pt-10 md:pt-0 pt-10">
                <h1 className="text-textPrimary dark:text-textSecondary uppercase font-bold text-2xl">
                  Social Info
                </h1>
                <motion.div
          ...
          <motion.div
            ...
            className="lg:col-span-2 mt-8 lg:mt-0 mt-0"
          >
            <div
