...
export default function ProjectCarousel({ projects, filteredProjects = projects }: ProjectCarouselProps) {
  ...
  return (
    <div className="relative w-[1000px] mx-auto px-4 py-8">
      <div
          ...
          >
            <div className="h-full flex flex-col">
              <div className="relative overflow-hidden h-1/2">
                <img
                  src={projectsToShow[currentIndex]?.image}
        ...
        {projectsToShow.map((_, index) => (
          <button
            ...
            className={`w-3 h-3 rounded-full transition-all ${
              index === currentIndex ? "bg-brand w-6" : "bg-gray-300 dark:bg-gray-600"
            }`}
